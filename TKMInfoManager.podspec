...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of TKMInfoManager.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhengxianda0512@gmail.com/TKMInfoManager'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhengxianda0512@gmail.com' => 'xianda.zheng@email.com' }
  s.source           = { :git => 'https://github.com/zhengxianda0512@gmail.com/TKMInfoManager.git', :tag => s.version.to_s }
